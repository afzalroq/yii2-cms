...
<div class="pages-form">
    ...
    $haveCommonAttr = $collection->manual_slug ||
        $model->isAttrCommon('name') ||
        $model->isAttrCommon('content') ||
        $model->isAttrCommon('file_1') ||
        $model->isAttrCommon('file_2') ||
  ...
  <div class="sticky">
      <?= Html::submitButton('<i class="fa fa-plus"></i> ' . Yii::t('cms', 'Save and Add new'),
          ['class' => 'btn btn-success', 'name' => 'save', 'value' => 'add-new']) ?>
      <?= Html::submitButton('<i class="fa fa-check"></i> ' . Yii::t('cms', 'Save and Close'),
          ['class' => 'btn btn-warning', 'name' => 'save', 'value' => 'save-close']) ?>
      <?= Html::submitButton('<i class="fa fa-refresh"></i> ' . Yii::t('cms', 'Save'),
          ['class' => 'btn btn-primary', 'name' => 'save', 'value' => 'save']) ?>
      <?= Html::a('<i class="fa fa-close"></i> ' . Yii::t('cms', 'Close'),
          ['/cms/options/index', 'slug' => $collection->slug], [
