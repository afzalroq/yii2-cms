...
<script>
    document.querySelector('#entities-use_date').style.borderColor = 'transparent'
    document.querySelector('#entities-file_1_mimeType').style.borderColor = 'transparent'
    document.querySelector('#entities-file_2_mimeType').style.borderColor = 'transparent'
    document.querySelector('#entities-file_3_mimeType').style.borderColor = 'transparent'
</script>
